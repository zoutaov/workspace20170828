...
#define S14 22
	...
	/* 2 */
	FF( c, d, a, b, in[ 2], S13, 606105819UL);
	/* 3 */
	...
	/* 8 */
	FF( a, b, c, d, in[ 8], S11, 1770035416UL);
	/* 9 */
...
#define S24 20
	...
	/* 24 */
	GG( a, b, c, d, in[ 9], S21, 568446438UL);
	/* 25 */
...
#define S44 21
	...
	/* 56 */
	II( a, b, c, d, in[ 8], S41, 1873313359UL);
	/* 57 */
	II( d, a, b, c, in[15], S42, 4264355552UL);
	/* 58 */
	II( c, d, a, b, in[ 6], S43, 2734768916UL);
	/* 59 */
	II( b, c, d, a, in[13], S44, 1309151649UL);
	/* 60 */
